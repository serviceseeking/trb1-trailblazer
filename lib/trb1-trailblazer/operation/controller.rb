require "trb1-trailblazer/endpoint"

module Trb1::Trailblazer::Operation::Controller
private
...
private
  ...
  def operation_for!(operation_class, options, &block)
    ...
    res, op = Trb1::Trailblazer::Endpoint.new(operation_class, params, request, options).(&block)
